...
//Find first and last positions of an element in a sorted array(approach using binary search)

public class Practice4 {

	public static void main(String[] args) {
		/*
		 * int arr[] = { 1, 2, 2, 2, 2, 3, 4, 7, 8, 9, 8 }; int x = 8; int n =
		 * arr.length;
		 */
		int arr[] = { 1, 2, 2, 2, 2, 3, 4, 7, 8, 9, 8 };
		int n = arr.length;
		int x = 8;
